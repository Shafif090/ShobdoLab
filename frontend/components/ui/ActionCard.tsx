...
export function ActionCard({
  ...
  return (
    <Link
      href={href}
      className={`group block ${offset ? "sm:pl-8" : compactRight ? "sm:pr-8" : ""}`}>
      <div
        className={`border-2 border-black p-5 shadow-brutal transition duration-200 group-hover:-translate-y-1 group-hover:shadow-[0_6px_0_0_#000] sm:p-6 ${classes}`}
