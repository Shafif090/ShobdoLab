  ...
  return (
    <AppShell
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-5 sm:gap-6">
        <section className="rounded-[24px] border border-[rgba(255,200,0,0.40)] bg-[rgba(255,200,0,0.12)] p-5 sm:p-6">
        ...
        {loading ? (
          ...
          <div className="grid gap-3 sm:gap-4 md:grid-cols-2">
            {achievements.map((achievement) => {
              ...
              const progressLabel = achievement.earned
                ? achievement.target
              ...
              return (
                <article
                  ...
                  className={`flex min-h-[230px] flex-col rounded-[24px] border p-5 shadow-soft transition ${
                    achievement.earned
                  ...
                  <div className="mt-auto pt-5">
                    <div className="mb-2 flex items-center justify-between text-xs font-bold text-slate-500">
                      <span>Progress</span>
                      <span>
                        {progressLabel}/{achievement.target}
                      </span>
                    </div>
          ...
          <EmptyState
            ...
            body="Start learning or finish a quiz to unlock your first badge."
          />
        )}
      </div>
    </AppShell>
